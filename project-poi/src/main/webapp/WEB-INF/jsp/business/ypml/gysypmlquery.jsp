...
var columns = [ [{
	...
	formatter: function(value,row,index){
		...
		return '<input type="hidden" name="gysypmls['+index+'].ypxxid" value="'+value+'" />';
	}
},{
	field : 'usergysmc',
	title : '供货企业',
...
<div id="ypxxquery_div">
    <form id="gysypmldeleteForm" name="gysypmldeleteForm" action="${baseurl}ypml/gysypmldeletesubmit.action" method="post">
