...
<form id="yycgdsaveForm" name="yycgdsaveForm" action="${baseurl}cgd/yycgdaddsubmit.action" method="post">
					...
					<TABLE class="toptable grid" border=1 cellSpacing=1 cellPadding=4
						...
						<TBODY>
							...
							<TR>
								...
								${year}
								<input type="hidden" name="businessyear" value="${year}" />
								</TD>
								<TD height=30 width="15%" align=right >采购单名称：</TD>
								<TD class=category width="35%">
								<div>
								<input type="text" id="yycgd_mc" name="yycgd.mc" value="${yycgdmc}"  style="width:260px" />
								</div>
							...
							<TR>
								...
								<TD class=category width="35%">
								<input type="text" name="yycgd.lxr" id="yycgd.lxr"  style="width:260px" />
								</TD>
								<TD height=30 width="15%" align=right >联系电话：</TD>
								<TD class=category width="35%">
								<input type="text" name="yycgd.lxdh" id="yycgd.lxdh" style="width:260px" />
								</TD>
							</TR>
							<TR>
								...
								<TD colspan=3>
									<textarea rows="2" cols="30" name="yycgd.bz"></textarea>
								</TD>
							</TR>
