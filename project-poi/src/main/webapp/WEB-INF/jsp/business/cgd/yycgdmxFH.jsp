...
var columns = [ [ {
	...
	hidden : true,
	formatter: function(value,row,index){
		return '<input type="hidden" name="yycgdmxs['+index+'].yycgdid" value="'+row.yycgdbm+'" />';
	}
},
 {
	field : 'useryymc',
...
function initGrid(){
	$('#yycgdmxlist').datagrid({
		...
		striped : true,
		//collapsible : true,
		url : '${baseurl}cgd/yycgdmxFH_result.action',
...
<BODY>
    <form id="yycgddisposeForm" name="yycgddisposeForm" method="post" action="${baseurl}cgd/yycgdmxFHsubmit.action">
