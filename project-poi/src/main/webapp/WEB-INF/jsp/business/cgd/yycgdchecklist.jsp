...
},
{
	...
	formatter: function(value,row,index){
		return '<input type="hidden" name="yycgds['+index+'].id" value="'+value+'" />';
	}
},
{
	field : 'useryyid',
	hidden : true,
	formatter: function(value,row,index){
		return '<input type="hidden" name="yycgds['+index+'].useryyid" value="'+value+'" />';
	}
},
{
	field : 'opt',
	...
	width : 100,
	formatter: function(value,row,index){
		var string= '<select name="yycgds['+index+'].zt">'
		+'<option value=""></option>'
...
},
{
	...
	width : 180,
	formatter: function(value,row,index){
		return '<input type="text" name="yycgds['+index+'].shyj" />';
	...
	width : 60,
	formatter:function(value, row, index){
		return '<a href=javascript:yycgdview("'+row.yycgdbm+'")>查看</a>';
	}
},
...
function initGrid(){
	$('#yycgdlist').datagrid({
		...
		striped : true,
		//collapsible : true,
		url : '${baseurl}cgd/yycgdchecklist_result.action',
...
<BODY>
    <form id="yycgdqueryForm" name="yycgdqueryForm" method="post" action="${baseurl}cgd/yycgdchecksubmit.action">
