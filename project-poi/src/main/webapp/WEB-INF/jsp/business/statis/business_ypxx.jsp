...
function initGrid(){
	$('#businesslist').datagrid({
		...
		striped : true,
		//collapsible : true,
		url : '${baseurl}/business/business_ypxx_result.action',
		queryParams:{
			businessyear:'${year}'
		},
		//sortName : 'code',
	...
	$(function(){
		...
		//加载采购状态
		getDictinfoCodelist('011','yycgdCustom_cgzt');
	});
</script>
</HEAD>
<BODY>
			...
			<TABLE  class="table_search">
				<TBODY>
					<TR>
						...
						<td >
						<select id="businessyear" name="businessyear"></select>
						</td>
					...
					<TR>
					 ...
					 <INPUT id="yycgdCustom.cjtime_end" 
						...
						<td >
							<select id="yycgdCustom_cgzt" name="yycgdCustom.cgzt" style="width:150px">
							</select>
