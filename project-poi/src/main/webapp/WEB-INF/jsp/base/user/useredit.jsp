...
<body>
<form id="sysusereditform" action="${baseurl}user/usereditsubmit.action" method="post">
<input type="hidden" name="sysuser.id" value="${sysuserCustom.id}" />
						...
						<TBODY>
							...
							<TR>
								...
								<TD class=category width="35%">
									<div>
										<input type="text" id="sysuser_userid" name="sysuser.userid" value="${sysuserCustom.userid}" />
								...
								<TD class=category width="35%">
									<div>
										<input type="text" id="sysuser_username"
											name="sysuser.username" value="${sysuserCustom.username}"/>
									</div>
							...
							<TR>
								...
								<TD class=category width="35%">
									<input type="text" name="sysuser.sysid" value="${sysuserCustom.sysmc}"/>
								</TD>
								
								<TD height=30 width="15%" align=right>用户状态：</TD>
								<TD class=category width="35%">
									<input type="radio" name="sysuser.userstate" value="1" <c:if test="${sysuserCustom.userstate=='1'}">checked</c:if>/>正常
									<input type="radio" name="sysuser.userstate" value="0" <c:if test="${sysuserCustom.userstate=='0'}">checked</c:if>/>暂停
								</TD>
							</TR>
							<tr>
